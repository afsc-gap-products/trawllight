...
vessel <- 162 # Replace with vessel
cruise <- 201902 # Replace with cruise
survey <- "NBS" # Region ("BS", "NBS", "GOA", "AI", or "SLOPE")

# Setup directory
source_path <- "G:/RACE_LIGHT/LightData/Data/year_19/nbs/v_162/" # Replace with the source directory
