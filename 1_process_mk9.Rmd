...
vessel <- 147 # Replace with vessel
cruise <- 200501 # Replace with cruise
survey <- "GOA" # Region ("BS", "NBS", "GOA", "AI", or "SLOPE")

# Setup directory
source_path <- "G:/RACE_LIGHT/LightData/Data/year_05/goa/v_147/" # Replace with the source directory
